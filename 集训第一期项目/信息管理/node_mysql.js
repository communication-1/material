...
//        console.log("Request for " + arg );  
 ...
 //       console.log("name = "+name);
  ...
  //      console.log("pass= "+pass);
        var param=[ hao,password,name,aga,gander,year,month,day,home,forte,interest,phone,email,text];
 //       console.log(param);
        var sql ="insert into "+TEST_TABLE+" set hao=?,password=?,name?,aga?,gander?,year?,month?,day?,home?,forte?,interest?,phone?,email?text?";
 //       console.log(sql);
